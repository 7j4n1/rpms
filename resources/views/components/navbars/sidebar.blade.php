...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">IFS | RPMS</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto max-height-vh-100" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Paper Pages</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'papers' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('my-papers') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">My Papers</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'billing' ? ' active bg-gradient-primary' : '' }}  "
                    ...
                    <span class="nav-link-text ms-1">New Upload</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'billing' ? ' active bg-gradient-primary' : '' }}  "
                    ...
                    <span class="nav-link-text ms-1">Shared Papers</span>
                </a>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link text-white " href="javascript:;" onclick="event.preventDefault();document.getElementById('logout-form-1').submit();">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
